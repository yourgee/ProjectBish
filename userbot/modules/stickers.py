...
KANGING_STR = [
    "alin minta stikelnya yaa...",
    "alin minta lagi hehe...",
    "maapin alin, minta tikel terus...",
    "aliiinnn mintaaaaaaa...",
]
...
async def kang(args):
    ...
    if photo:
        ...
        packname = f"alin_{pack}"
        packnick = f"sticker alin.{pack}"
        cmd = '/newpack'
        file = io.BytesIO()
        ...
        await args.edit(f"`makasii om stickelnyaaa:)`\
            \nklik disini sayang! [ini](t.me/addstickers/{packname})",
                        parse_mode='md')
